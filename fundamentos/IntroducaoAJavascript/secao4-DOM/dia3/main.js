...
//Por causa da classe .tech no CSS que altera o primeiro li
...
const clickLi = (event) => {
    const whereIsTech = document.querySelector('.tech');
    whereIsTech.classList.remove('tech');
...
myWebpage.addEventListener('dblclick', () => {
    window.location.replace('https://devlucascbmelo.github.io/')
});
